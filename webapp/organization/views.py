...
class OrganizationCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            _('Organization "{organization_name}" created successfully.').format(
...
class OrganizationSwitchView(LoginRequiredMixin, RedirectView):
    """Vue pour changer l'organisation courante."""

    permanent = False

    def get_redirect_url(self, *args, **kwargs):
        """Changer l'organisation courante dans la session."""
        ...
        if organization_id:
            ...
            try:
                ...
                messages.success(
                    self.request,
                    _('Organization "{organization_name}" selected.').format(
                        organization_name=organization.name
                    ),
                )
