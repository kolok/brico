...
abstract class AppLocalizations {
  ...
  /// Generic error message with an interpolated error cause
  ///
  /// In en, this message translates to:
  /// **'Error: {error}'**
  ...
  /// No description provided for @confirmEmailRequired.
  ///
  /// In en, this message translates to:
  /// **'Please confirm your email'**
  String get confirmEmailRequired;
  ...
  ///
  /// In en, this message translates to:
  /// **'Your assistant for all your DIY projects'**
